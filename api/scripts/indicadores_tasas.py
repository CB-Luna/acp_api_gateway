...
def actualizar_registro_todos(id_existing_record, tasa_descuento_minima, tasa_descuento_maxima, tasa_descuento_media, tasa_descuento_moda, tasa_descuento_promedio):
    """
    ...
    try:
        ...
        if input_response.status_code == 200:
            ...
            if responseDF.isEmpty() == False:
                ...
                actualizar_registro_todos(id_existing_record, tasa_descuento_minima, tasa_descuento_maxima, tasa_descuento_media, tasa_descuento_moda, tasa_descuento_promedio)
